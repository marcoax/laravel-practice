...
| 9 | `branch_convention` | `one branch per generated brief, e.g. lesson-NN-<slug>` | Free text; the **branch-name pattern**. Consulted only by `/lesson-update`, when `auto_branch` is `on` (ADR-0017). |
